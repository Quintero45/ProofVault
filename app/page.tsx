    ...
    <div className="relative min-h-screen bg-black text-white flex flex-col overflow-hidden">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <Link href="/files" className="hover:text-gray-400 text-sm">
            Files
          </Link>
        </div>

        {/* Wallet Connect */}
        <div className="hidden lg:block">{mounted && <ConnectButton />}</div>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center text-center px-4 sm:px-6 z-10 mt-12 sm:mt-20 md:mt-28">
        ...
        <p className="max-w-md sm:max-w-xl text-white-400 mb-6 text-sm sm:text-base">
          Register proof of authorship, existence, or integrity of any file on
          the blockchain—without revealing its content or needing lawyers.
          Generate a verifiable cryptographic receipt in seconds.
        </p>
